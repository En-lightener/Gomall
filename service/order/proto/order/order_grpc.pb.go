...
func (c *orderServiceClient) ProcessOrder(ctx context.Context, in *ProcessOrderReq, opts ...grpc.CallOption) (*ProcessOrderResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProcessOrderResp)
...
type OrderServiceServer interface {
	...
	ProcessOrder(context.Context, *ProcessOrderReq) (*ProcessOrderResp, error)
...
func (UnimplementedOrderServiceServer) ProcessOrder(context.Context, *ProcessOrderReq) (*ProcessOrderResp, error) {
...
func _OrderService_ProcessOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ProcessOrder(ctx, req.(*ProcessOrderReq))
	}
	return interceptor(ctx, in, info, handler)
}
